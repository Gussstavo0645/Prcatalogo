   ...
   public function store(Request $request, Catalogo $catalog)
{
    ...
    try {
        // 1. Validar combo en inventario remoto
        $comboInvQuery = $admin
        ...
        // 2. Validar productos internos en admin_ml
...
if ($productColor === '') {
    ...
    DB::transaction(function () use ($catalog, $data, $comboInv, $comboCode, $comboColor, $imagePath, $componentesValidados) {
        ...
        foreach ($componentesValidados as $row) {
