...
<div id="secProductos" class="admin-tab-panel {{ !$catalog ? 'disabled-block' : '' }}">
    ...
    <div class="section-card {{ !$catalog ? 'disabled-block' : '' }}">
        ...
        <div class="card-body">
                        ...
                        @else
                            {{-- FILTRO GENERAL --}}
                            <form method="GET" action="{{ route('admin.catalogs.products.search') }}" class="mb-4"
                                id="productsFilterForm">
                                <input type="hidden" name="catalog" value="{{ request('catalog') }}">
                                <input type="hidden" name="mesyope"
                                ...
                                <div class="row g-3 align-items-end">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="number" name="filter_page" class="form-control" min="1"
                                            value="{{ request('filter_page', $pageFilter ?? '') }}" placeholder="27">
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row g-3 align-items-end">
                                            <div class="col-md-3">
                                                ...
                                                <input type="number" id="bulkPageNumber" class="form-control"
                                                    min="1" value="1" required>
                                            </div>

                                            <div class="col-md-3">
                                                <label class="form-label fw-bold">Cantidad</label>
                                                <input type="number" id="bulkQuantity" class="form-control"
                                                    min="1" value="1" required>
                                            </div>

                                            <div class="col-md-3">
                                                <label class="form-label fw-bold">Seleccionados</label>
                                                <input type="text" id="selectedCount" class="form-control"
                                                    value="0 productos" readonly>
                                            </div>
                                        ...
                                        <div class="col-6 col-md-4 col-lg-3">
                                            <div class="card h-100 shadow-sm">
                                                ...
                                                <div class="card-body p-2">
                                                    ...
                                                    <form
                                                        action="{{ route('admin.catalogs.paginas.destroy', [$catalog->id, $pagina->id]) }}"
                                                        method="POST"
...
@section('scripts')
    ...
    @php
        ...
        $cartItems = collect($cartItems)
            ->sortBy([['page_number', 'asc'], ['position', 'asc']])
            ->values()
            ->all();
    @endphp
